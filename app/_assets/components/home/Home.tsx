            ...
            <div className="jumbotron row">
              <div className="col-md-6 left">
                <div className="site-title">
                  <h1 className="headline text-center">Primal Strength</h1>
                  <p className="tagline text-center">
                    Living strong. Staying positive.
                  </p>
                </div>
                <div className="btn-learn-more">
                  <a className="btn btn-primary" href="#featured-posts">
                    Read More{' '}
                  </a>
                </div>
              </div>
              <div className="col-md-6 right">
                ...
                <div className="site-description">
                  ...
                  <p>
                    Living strong and staying positive with strength training,
