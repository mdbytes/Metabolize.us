            ...
            <div className="row">
                <div className="col about">
                    ...
                    <p>
                        ...
                        and carried it well on a large muscular frame. My
                        constitution kept me active as an athlete. I knew myself
                        as a big strong man who came from a family of big strong
                        men. That was it. No one was obese. No one discussed
                        personal family health matters. I had no idea that type
                        2 diabetes had been a big part of family history. I was
                        obese and comfortably in the dark about the real
                        challenges it presented.
                        <br />
                        <br />
                        My waistline grew steadily. It was well over 40 inches
                        within a few years of playing college athletics. By age
                    ...
                    <ul>
                        ...
                        <li>Lost 50 pounds on the Zone Diet</li>
                        <li>Lost 40 pounds on the Pritikin Diet</li>
                        <li>Lost 30 pounds on the South Beach Diet</li>
                        <li>Lost 20 pounds at Nutri-System</li>
                        <li>Lost 15 pounds at Weight Watchers</li>
                    </ul>
                    <p>
                        Just on these six programs, I lost 225 pounds. That
                        would be great. But obesity raised it&apos;s ugly head
                        every time. I would gain the weight all back, usually
                    ...
                    <p>
                        ...
                        type 2 diabetes had disappeared, blood pressure
                        medication had been reduced to the lowest available
                        dose. It was miraculous. But the past seven years were
                        neither easy nor perfect. Weight was inevitably gained
